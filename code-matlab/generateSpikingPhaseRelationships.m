...
%         ax.YLim = [-3 10];
        ...
        save(strcat(fn_prefix, '_phase_response'), 'out');
        print(this_fig, '-dpng', strcat(fn_prefix, '_phase_response_hist'));
        savefig(this_fig, strcat(fn_prefix, '_phase_response_hist'));
        close;
    end
end
