...
%% Create Filter
clear D ALL
filter_orders = 25:10:55; % low gamma
%filter_orders = 10; % delta
filter_count = 1;
for iOrd = 1:length(filter_orders)
D{filter_count} = designfilt('bandpassfir', 'FilterOrder', filter_orders(iOrd), 'CutoffFrequency1', 24, 'CutoffFrequency2', 56, 'StopbandAttenuation1', 60, 'PassbandRipple', 1, 'StopbandAttenuation2', 60, 'SampleRate', Fs); % gamma
...
optimal_parameters = phastimate_optimize(ALL.data, ALL.true_phase, D, [1 length(filter_orders)], [600 2000], [20 80], [20 100], 128)
