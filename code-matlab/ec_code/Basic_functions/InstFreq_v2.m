function [IaF,NegValuesPos,xm,dm,orig_phase]=InstFreq_v2(x,dt,typeEnv,fig,sm,verbose)
...
%    phase = Instantaneous phase of signal (MvdM addition)
%
% Input
%
%   x     = signal
...
% MvdM additions to preserve length
orig_phase = cat(2,NaN,orig_phase,NaN);
IaF = cat(2,NaN,NaN,IaF,NaN,NaN);
