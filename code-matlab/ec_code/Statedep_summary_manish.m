...
function statedep_summary_manish

all_lat_dir = 'E:\temp_phase_stim\MD\all_lat_dir';
% all_fig_dir = 'E:\temp_phase_stim\ED\M16-2019-02-18_vStr_4p0_light_cells_TT4_min\figures';
summary_dir = 'E:\temp_phase_stim\MD\';

set(0, 'DefaultTextInterpreter', 'none')
set(0, 'DefaultLegendInterpreter', 'none')
set(0,'defaultAxesTickLabelInterpreter','none');  
PARAMS.Good_cells = {'M325_2022_08_03_TT02_3', 'M325_2022_08_03_TT03_4', 'M265_2021_12_27_TT07_1'};
font_size = 18;
...
%         if ismember(this_cell, PARAMS.Good_cells) % check if this is a 'good' cell from above approvedd list
%             
%             freq_list = fieldnames(out.(this_cell));
%             
%             
...
% 
%         else
%             disp(['Skippking ' this_cell '.  Not a ''good'' cell'])
%         end
...
cell_names = cell_names(~cellfun('isempty',cell_names)); 
...
for iC = 1:length(cell_list)
    ...
    % get the probe depth
    this_depth(1,1:(cut_idx(2)-cut_idx(1))+1) = all_cells.(this_cell).ExpKeys.probeDepth;
    % subect ID
